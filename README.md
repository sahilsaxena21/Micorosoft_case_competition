...
| Mobile App Product Recommendations | Historic customer app click data | Develop and Deploy an ML Classifier model that predicts a customer's affinity to each product category |
